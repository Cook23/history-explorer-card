 ...
 */
(function (f) {if (typeof exports === "object" && typeof module !== "undefined") {module.exports = f();} else if (typeof define === "function" && define.amd) {define([], f);} else {var g;if (typeof window !== "undefined") {g = window;} else if (typeof global !== "undefined") {g = global;} else if (typeof self !== "undefined") {g = self;} else {g = this;}g.HXLocal_Chart = f();}})(function () {var define, module, exports;return function e(t, n, r) {function s(o, u) {if (!n[o]) {if (!t[o]) {var a = typeof require == "function" && require;if (!u && a) return a(o, !0);if (i) return i(o, !0);var f = new Error("Cannot find module '" + o + "'");throw f.code = "MODULE_NOT_FOUND", f;}var l = n[o] = { exports: {} };t[o][0].call(l.exports, function (e) {var n = t[o][1][e];return s(n ? n : e);}, l, l.exports, e, t, n, r);}return n[o].exports;}var i = typeof require == "function" && require;for (var o = 0; o < r.length; o++) s(r[o]);return s;}({ 1: [function (require, module, exports) {
...
/*      if (typeof window !== 'undefined') {
      ...
      module.exports = {
        ...
        modes: {
          ...
          nearest: function (chart, e, options) {
            ...
            let e0 = nearestItems.slice(0, 1);

            // Hide the elements if they're too far from the mouse pointer (Alex)
            if( !options.intersect && e0.length > 0 ) {
                const cp = e0[0].getCenterPoint();
                const d = position.y - cp.y;
                if( d > 20 || d < -5 ) e0 = [];     // 20 pixels below the curve and 5 pixels above
            }
      ...
      module.exports = function (Chart) {
        ...
        Chart.Scale = Element.extend({
          ...
          update: function (maxWidth, maxHeight, margins) {
            ...
            // Optionally remove first and last label (Alex)
            if( me.options.ticks.removeEdgeTicks ) {
                labels[0] = ' ';
      ...
      module.exports = function (Chart) {
        ...
        function determineAlignment(tooltip, size) {
          ...
          return {
            ...
            yAlign: opts.yAlign ? ( opts.yAlign == 'nocenter' ) ? ( yAlign == 'center' ) ? 'top' : yAlign : opts.yAlign : yAlign 
          };
        ...
        Chart.Tooltip = Element.extend({
          ...
          draw: function () {
            ...
            // Don't fade tooltip, but keep delay (Alex)
      ...
      moment = typeof moment === 'function' ? moment : window.HXLocal_moment;
      ...
      function interpolate(table, skey, sval, tkey) {
        ...
        var _momentCache = new Map();

        function momentCache(tc)
        {
            let r;
            if( tc !== undefined ) {
                if( !_momentCache.has(tc) ) {
                    r = moment(tc);
                    _momentCache.set(tc, r);
                } else 
                    r = _momentCache.get(tc);
            }
            return r;
        }
